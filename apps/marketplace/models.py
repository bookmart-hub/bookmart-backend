...
class Listing(models.Model):
    ...
    book = models.ForeignKey(
        Book, on_delete=models.PROTECT, related_name='listings')
...
class PlatformReport(models.Model):
    ...
    target_listing = models.ForeignKey(
        Listing, on_delete=models.SET_NULL, null=True, blank=True, related_name='reports')
    target_user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL,
                                    null=True, blank=True, related_name='targeted_reports')
...
class BookContactLedger(models.Model):
    ...
    user = models.ForeignKey(settings.AUTH_USER_MODEL,
                             on_delete=models.CASCADE, related_name='deal_logs')
